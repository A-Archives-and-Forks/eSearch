    ...
    全局: {
        ...
        主题: {
            light: {
                ...
                iconColor:
                    "invert(6%) sepia(11%) saturate(695%) hue-rotate(169deg) brightness(95%) contrast(88%)",
            },
            dark: {
                emphasis: "#3B4858",
                barbg: "#3B4858",
                ...
                iconColor:
                    "invert(99%) sepia(21%) saturate(4777%) hue-rotate(180deg) brightness(109%) contrast(106%)",
            },
        },
    },
    工具栏: {
